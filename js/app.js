...
//Q1. kicks off the nested if/else statement below.
...
//Q2.Here is my seccond question, and the begining of my if statement
...
if(answer.includes(horror.toLowerCase())){
  ...
  //Q3. Nested in the 2nd qhesitons if statement, the full third.
...
if (answer.includes(like_comic.toLowerCase())){
